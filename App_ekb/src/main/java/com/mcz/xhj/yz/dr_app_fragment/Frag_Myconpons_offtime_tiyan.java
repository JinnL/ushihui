...
public class Frag_Myconpons_offtime_tiyan extends BaseFragment {
	@BindView(R.id.lv_conpons_finish)
	ListView lv_conpons;
	@BindView(R.id.ptr_conponsfinish)
	PtrClassicFrameLayout ptr_conponsfinish;
	...
	protected void initParams() {
		getData();
		ptr_conponsfinish.setPtrHandler(new PtrHandler() {
	...
	private void getData() {
		OkHttpUtils.post().url(UrlConfig.CONPONSUNUSE)
				...
				.execute(new StringCallback() {
					...
					public void onResponse(String result) {
						ptr_conponsfinish.refreshComplete();
