...
public class HorizontalProgressBarWithNumberNewHand extends ProgressBar {
    ...
    public HorizontalProgressBarWithNumberNewHand(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HorizontalProgressBarWithNumberNewHand(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        if (endX > -1) {
            ...
            LinearGradient shader = new LinearGradient(-90, 0 , 100, endX, new int[]{0xFF56CCFF,0xFF7196F9},null, Shader.TileMode.CLAMP);
