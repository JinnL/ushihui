...
public class CashOutAct extends BaseActivity {
...
//	}
    ...
    public void onResume() {
        ...
        MobclickAgent.onEvent(CashOutAct.this, UrlConfig.point + 30 + "");
    }
...
//				startActivityForResult(new Intent(CashOutAct.this, TransactionPswAct.class));
//			}
//		});
        ...
        tv_commom_question.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(CashOutAct.this, CallCenterActivity.class));
            }
        });
        tv_contact_us.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogMaker.showKufuPhoneDialog(CashOutAct.this);
            }
        });
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (obj.getBoolean(("success"))) {
                            ...
                            startActivityForResult(new Intent(CashOutAct.this, CashIn_End.class).putExtra("flag", "cashout-success").putExtra("withdrawalsTime", withdrawalsTime).putExtra("money", stringCut.space_Cut(et_money.getText().toString())), 4);
                            finish();
                        } else {
                            if ("XTWH".equals(obj.getString("errorCode"))) {
                                startActivity(new Intent(CashOutAct.this, WebViewActivity.class)
                            ...
                            switch (Integer.parseInt(obj.getString(("errorCode")))) {
                                case 9999:
                                    startActivityForResult(new Intent(CashOutAct.this, CashIn_End.class).putExtra("msgCode", "9999").putExtra("flag", "failiure_cashout").putExtra("msg", "系统繁忙"), 4);
                                    break;
                                case 1001:
                                    startActivityForResult(new Intent(CashOutAct.this, CashIn_End.class).putExtra("msgCode", "1001").putExtra("flag", "failiure_cashout").putExtra("msg", "提现金额不能小于3块"), 4);
                                    break;
                                case 1002:
                                    startActivityForResult(new Intent(CashOutAct.this, CashIn_End.class).putExtra("msgCode", "1002").putExtra("flag", "failiure_cashout").putExtra("msg", "交易密码不能为空"), 4);
                                    break;
                                case 1003:
...
//						showAlertDialog("提示", "连续输错三次密码，交易密码锁定一小时！请稍后再试或点击忘记密码。", new String[] { "稍后再试","忘记密码" }, true, true, "three_time");
                                    break;
                                case 1004:
                                    startActivityForResult(new Intent(CashOutAct.this, CashIn_End.class).putExtra("msgCode", "1004").putExtra("flag", "failiure_cashout").putExtra("msg", "余额不足"), 4);
                                    break;
                                case 1005:
                                    startActivityForResult(new Intent(CashOutAct.this, CashIn_End.class).putExtra("msgCode", "1005").putExtra("flag", "failiure_cashout").putExtra("msg", "交易失败,请再次申请"), 4);
                                    break;
                                case 1006:
//						ToastMaker.showShortToast("处理中,请查看交易信息");
                                    JSONObject objmap = obj.getJSONObject("map");
                                    startActivityForResult(new Intent(CashOutAct.this, CashIn_End.class).putExtra("flag", "cashout-progress")
                                    ...
                                    break;
                                case 1007:
                                    startActivityForResult(new Intent(CashOutAct.this, CashIn_End.class).putExtra("msgCode", "1007").putExtra("flag", "failiure_cashout").putExtra("msg", "该笔需要收取手续费"), 4);
                                    break;
                                case 1008:
                                    startActivityForResult(new Intent(CashOutAct.this, CashIn_End.class).putExtra("msgCode", "1008").putExtra("flag", "failiure_cashout").putExtra("msg", "该笔不需要收取手续费"), 4);
                                    break;
                                case 1009:
                                    startActivityForResult(new Intent(CashOutAct.this, CashIn_End.class).putExtra("msgCode", "1008").putExtra("flag", "failiure_cashout").putExtra("msg", "渠道为空"), 4);
                                    break;
                                case 9998:
                                    finish();
                                    ...
                                    break;
                                case 2002:
                                    startActivityForResult(new Intent(CashOutAct.this, CashIn_End.class).putExtra("msgCode", "2002").putExtra("flag", "failiure_cashout").putExtra("msg", "返现或体验金收益需完成一次真实投资后才可提现"), 4);
                                    break;
                                default:
                                    break;
                            }
    ...
    public void onButtonClicked(Dialog dialog, int position, Object tag) {
        ...
        if (position == 1) {
            startActivity(new Intent(CashOutAct.this, NewForgetPswActivity.class).putExtra("isFrom", 1));
        }
    }
...
//					Integer pic = new BankName_Pic(bankid).bank_Pic();
                            ...
                            if (i == 2) {
                                MobclickAgent.onEvent(CashOutAct.this, "100023");
                                if ("0".equals(ispwd)) {
                                    ...
                                    pop.showPopWindow(CashOutAct.this, CashOutAct.this, ll_all);
                                    if (istip == 1) {
                                    ...
                                    pop.setCallBackTradePwd(new TradePwdPopUtils.CallBackTradePwd() {
                                        ...
                                        @Override
                                        public void callBaceTradePwd(String pwd) {
                                            MobclickAgent.onEvent(CashOutAct.this, UrlConfig.point + 31 + "");
                                            doCashOut(istip, pwd);
                                        }
                                    });
                                    pop.showPopWindow(CashOutAct.this, CashOutAct.this, ll_all);
