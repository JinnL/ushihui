...
//        animator.setRepeatMode(com.nineoldandroids.animation.ValueAnimator.RESTART);
...
//        animator.setRepeatCount(0);
    ...
    private void initFromAttributes(Context context, AttributeSet attrs) {
        ...
        mStyle = a.getInt(R.styleable.CircleProgressBar_stylel, LINE);
...
//        canvas.drawText("抢购中", mCenterX, mCenterY + mProgressTextRect.height() / 2, mProgressTextPaint);
    }
