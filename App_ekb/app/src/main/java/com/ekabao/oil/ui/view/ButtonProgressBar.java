...
public class ButtonProgressBar extends View {
    ...
    private static final int DEFAULT_BGCOLOR = Color.parseColor("#E07976"),
            DEFAULT_PROGCOLOR = Color.parseColor("#ff5959");
    ...
    public void init(Context context, AttributeSet attrs) {
        ...
        mTickBitmap = getBitmapFromVectorDrawable(context, R.drawable.icon_done);
        try {
            ...
            mTextColor = attributeArray.getColor(R.styleable.ButtonProgressBar_textColorbpb, Color.WHITE);
            mTextSize = attributeArray.getDimensionPixelSize(R.styleable.ButtonProgressBar_textSizebpb, mTextSize);
...
//        p.setTextSize(scalaFonts(size));
        canvas.drawText("更新中...",canvas.getWidth()/2-80,canvas.getHeight()/2+20,p);
    }
