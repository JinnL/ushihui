...
import com.ekabao.oil.util.FileUtilss;
...
//                LogUtil.d(TAG, "UpdateService+onStartCommand");
		...
		public void createNotification() {
                ...
                mViews = new RemoteViews(getPackageName(), R.layout.item_notification);
                mViews.setImageViewResource(R.id.notificationImage, R.mipmap.ic_launcher);
                ...
                builder.setSmallIcon(R.mipmap.ic_launcher).setWhen(System.currentTimeMillis()).setAutoCancel(true);// 设置可以清除
