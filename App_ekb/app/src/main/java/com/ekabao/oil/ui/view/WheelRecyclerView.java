...
public class WheelRecyclerView extends RecyclerView {
    ...
    private final int DEFAULT_SELECT_TEXT_SIZE = sp2px(14);

    private final int DEFAULT_UNSELECT_TEXT_SIZE = sp2px(14);
