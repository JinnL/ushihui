...
import com.mcz.xhj.yz.dr_util.UiUtils;
...
public class WaveProgressView extends View {
    ...
    private String mWaveColor = "#D33A31";
    private int mWaveSpeed = 40;//波纹速率
    ...
    private Bitmap createImage() {
        ...
        canvas.drawText(currentText, width / 2, height / 2 + UiUtils.dipToPx(getContext(),5), mTextPaint);

        // 绘制外圆环
        mCirclePaint.setStyle(Paint.Style.STROKE);
        mCirclePaint.setStrokeWidth(1);
        mCirclePaint.setAntiAlias(true);
        mCirclePaint.setColor(0XFFD33A31);
