...
public class MallActivity extends BaseActivity {
    ...
    private MallRecycleAdapter mallRecycleAdapter;
    ...
    protected void initParams() {
        ...
        titleCentertextview.setText("油实惠商城");
...
//        titleRightimageview.setImageResource(R.drawable.icon_mall_top_more);
        ...
        layoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
            ...
            public int getSpanSize(int position) {
                ...
                return position < MallRecycleAdapter.COUNT ? 2 : 1;
            }
        });
        rvHome.setLayoutManager(layoutManager);


        mallRecycleAdapter = new MallRecycleAdapter(this, 1);

        rvHome.setAdapter(mallRecycleAdapter);
    ...
    public void showPopupWindowLogin(View titleRightimageview) {
        ...
        if (popupWindow == null) {
            ...
            tvOrder.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (preferences.getString("uid", "").equalsIgnoreCase("")) {
                        ...
                        startActivity(new Intent(MallActivity.this, LoginActivity.class));
                    } else {
                        startActivity(new Intent(MallActivity.this, MallOrderActivity.class)
                                .putExtra("type", 2)
                        );
                    }
            ...
            tv_about.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // TODO: 2019/1/14
                    startActivity(new Intent(MallActivity.this, CallCenterActivity.class));
                  /*  startActivity(new Intent(MallHomeActivity.mContext, WebViewActivity.class)
                    ...
                    public void onResponse(String response) {
                        ...
                        if (obj.getBoolean(("success"))) {
                            ...
                            if (map.getJSONArray("category") != null) {
                                ...
                                mallRecycleAdapter.setCategoryBean((ArrayList<GoodsCategory>) categoryList);
                            ...
                            if (map.getJSONArray("good") != null) {
                               ...
                               /* if (pageon == 1) {
                                ...
                                //  mallRecycleAdapter.setCenterBean(homeHostProduct);
                                mallRecycleAdapter.setRefreshBean(rows_List, flagFirst);
                            ...
                            if (map.getJSONArray("bannerMiddle") != null) {
                                ...
                                //  mallRecycleAdapter.setCenterBean(homeHostProduct);
                                mallRecycleAdapter.setMiddlebanner(middlebanner);

                                LogUtils.e("易商城--->bannerMiddle" + arr.size());
                            }
                            ...
                            if (map.getJSONArray("banner") != null) {
                                ...
                                mallRecycleAdapter.setheaderbean(homeHostProduct);
                            ...
                            if (map.getJSONArray("newgood") != null) {
                                ...
                                mallRecycleAdapter.setNewGoods(goodslist);
                           ...
                           /* mallRecycleAdapter.setheaderbean(homeInfo);
                            mallRecycleAdapter.setCenterBean(homeInfo);
