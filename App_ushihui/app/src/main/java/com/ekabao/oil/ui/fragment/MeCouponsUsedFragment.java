...
import com.ekabao.oil.adapter.CouponsUsedAdapter;
...
public class MeCouponsUsedFragment extends BaseFragment {
    ...
    private String status = "1";// 状态 0：未使用  1：已使用 2：已过期
    private String flag = "-1";// //0 体验金 -1

    public static MeCouponsUsedFragment newInstance(int type) {

        Bundle args = new Bundle();

        MeCouponsUsedFragment fragment = new MeCouponsUsedFragment();
    ...
    protected void initParams() {
        ...
        adapter = new CouponsUsedAdapter(rvNews, lslbs, R.layout.item_coupons);
